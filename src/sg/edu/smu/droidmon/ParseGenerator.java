...
public class ParseGenerator {
	...
	private static String URLParse(Object obj) {
		URL url = (URL) obj;
		return url.toString();
	}
	...
	private static String httpResponseParse(Object obj) throws IOException {
	...
	public static JSONObject generateHookDataJson(MethodHookParam param) throws JSONException
	{
	...
	public static String parseReflectionMethodName(MethodHookParam param) {
	...
	public static String parseReflectionClassName(MethodHookParam param) {
